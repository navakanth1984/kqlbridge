...
# Optimization: Replaces character-by-character parsing loop with C-optimized regex
# finditer scanning. The fallback token (.) ensures no data is silently dropped.
