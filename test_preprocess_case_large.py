...
test_str = "DeviceEvents | extend Risk = case(ActionType == 'Logon', 1, ActionType == 'Logoff', 0, ActionType == 'ProcessCreated', case(InitiatingProcessFileName == 'cmd.exe', 2, 0), 0) " * 10
import timeit
print("Original:", timeit.timeit("from __main__ import _preprocess_case, test_str; _preprocess_case(test_str)", number=100))
print("Optimized:", timeit.timeit("from __main__ import _preprocess_case_optimized, test_str; _preprocess_case_optimized(test_str)", number=100))
