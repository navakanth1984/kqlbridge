...
def test_version_pin():
    """Verify library version is exactly v0.11.2, v0.11.3, v0.11.4, v0.11.5 or v0.12.0."""
    assert kqlbridge.__version__ in ("0.11.2", "0.11.3", "0.11.4", "0.11.5", "0.12.0"), f"Wrong version: {kqlbridge.__version__}"
