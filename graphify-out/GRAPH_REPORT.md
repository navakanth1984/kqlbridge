...
## Corpus Check
- 26 files · ~17,513 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 476 nodes · 788 edges · 19 communities (18 shown, 1 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 120 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a83d98fe`
...
Cohesion: 0.05
Nodes (91): Generates Spark SQL from a KQLQuery AST.      Usage:         gen = SparkSQLGener, Generates Spark SQL from a KQLQuery AST.      Usage:         gen = SparkSQLGener, SparkSQLGenerator, AggAvg, AggCount, AggCountIf, AggDCount, AggMax (+83 more)
...
Cohesion: 0.06
Nodes (30): examples/fabric_migration/01_simple_filter.py ==================================, The routing agent pattern from DE-Context Kit.     Routes each query to the most, route_query(), _check(), _lint(), cli.py — KQLBridge command-line interface ======================================, _translate(), check() (+22 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (33): DistinctOp, ProjectOp, | where Level == 'Error, | project Message, Level, | summarize count() by ServiceName, | where Level == 'Error, | project Message, Level  or  | project NewName=OldName, Level, | summarize count() by ServiceName (+25 more)
...
- **Why does `translate()` connect `Community 2` to `Community 1`, `Community 6`, `Community 9`?**
  _High betweenness centrality (0.248) - this node is a cross-community bridge._
- **Why does `sql()` connect `Community 1` to `Community 2`?**
  _High betweenness centrality (0.204) - this node is a cross-community bridge._
- **Why does `SparkSQLGenerator` connect `Community 0` to `Community 3`, `Community 4`, `Community 6`, `Community 7`?**
